        ...
        try:
            for subSubCat in subSubCategories:
                ...
                for product in products:
                    ...
                    scrapDict = {'Link':'https://www.leisuretec.co.uk' + product['href'], 'brand':productBrand, 'productName':productName,'RRP':rrp, 'mpn':mpn, 'Description':description,'image':image}
                    dfLeisureTec = dfLeisureTec.append(scrapDict, ignore_index=True)
                    dfLeisureTec.to_excel('LeisureTec.xlsx',index=False)
